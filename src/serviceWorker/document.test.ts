...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.freeuniswap.org', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.freeuniswap.org', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.freeuniswap.org', pathname: '/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.freeuniswap.org', pathname: '/asset.gif' } }, false],
